...
<link rel="stylesheet" href="fontawesome/css/all.min.css">
    ...
    <div class="container-fluid">
        ...
        <div id="myCollapse" class="collapse navbar-collapse">
            <ul class="navbar-nav me-auto">
                ...
                if($_SESSION['role'] == "admin") {
                        ?>
                <li class="nav-item"><a href="Items.php" class="nav-link" style="display:none;">Items</a></li>
                <?php
                    }//END if($_SESSION['role'] == "admin")
                ?> 
                <?php
                if($_SESSION['role'] == "admin") {
                        ?>
                <li class="nav-item"><a href="categories.php" class="nav-link" style="display:none;">categories</a></li>
                <?php
                    }//END if($_SESSION['role'] == "admin")
                ?> 
 ...
 <?php
                if($_SESSION['role'] == "admin") {
                        ?>
                <li class="nav-item"><a href="Quantities.php" class="nav-link" style="display:none;">Quantities</a></li>
                <?php
                    }//END if($_SESSION['role'] == "admin")
                ?> 
                <?php
...
<div id="mySidenav" class="offcanvas offcanvas-start">
	...
	<div class="container row mx-auto align-items-center" style="margin-top: 150px; margin-bottom: 200px;" >
		<div class="row">
			<div class="col-md-4">
                <?php
                if($_SESSION['role'] == "admin") {
                ...
                ?>   
                    <div class="card border-left-warning shadow h-70 py-2" >
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-we Groupight-bold text-warning text-uppercase mb-1">
                                      <b>  Items</b> </div>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800"></div>
                                </div>
                                <div class="col-auto">
